...
//////////////////////////////////////////////////////Menu Principal/////////////////////////////////////////////////////////////
   int main(){
      printf("................................Bienvenidos al juego de Damas en C................................\n");

     printf("\nSeleccione la opcion que desea Accionar.\n");
	int menu;
	int aux=0;

     while(aux!=1){

      printf("\nPulse [1] para jugar Damas en C:\nPulse [2] para leer las Reglas del juego:\nPulse [3] para digitar los jugadores:\npulse [4] para salir del menu del juego: \n");
      scanf("%d",&menu);
